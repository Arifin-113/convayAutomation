...
public class CM_OrganizationCreateNew {
    ...
    @Test(priority = 1)
    void CM_Organization_CreateNew() throws InterruptedException {
        CM_OrganizationCreateNew_Page manageOrg = new CM_OrganizationCreateNew_Page(driver);
        ...
        try {
            ...
            String setOrgName = ExcelWSheet.getRow(5).getCell(0).toString();
            
            String setAdminFirstName = ExcelWSheet.getRow(6).getCell(0).toString();
            String setAdminLastName = ExcelWSheet.getRow(7).getCell(0).toString();
            String setAdminContactNum = ExcelWSheet.getRow(8).getCell(0).toString();
            
            String setAdmingMail = ExcelWSheet.getRow(9).getCell(0).toString();
            Thread.sleep(2000);

            CM_OrganizationCreateNew_Page dp = new CM_OrganizationCreateNew_Page(driver);
            dp.setOrgName(setOrgName);
            Thread.sleep(3000);
            
            manageOrg.clickSuperAdminOrg();
            Thread.sleep(2000);
            
            dp.setAdminFirstName(setAdminFirstName);
            Thread.sleep(3000);
            
            dp.setAdminLastName(setAdminLastName);
            Thread.sleep(3000);
            
            dp.setAdminContactNum(setAdminContactNum);
            Thread.sleep(3000);
            
            dp.clicksetAdmingMail(setAdmingMail);
            Thread.sleep(3000);
            
            manageOrg.clicksaveCreateOrgBtn();
            Thread.sleep(2000);
